...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
         ...
         "weather": {
            "transport": "stdio",
            "command": r"D:\Agentic AI\TripMate-AgenticAI-App\tripmate_agenticai_langgraph\.travelmate\Scripts\python.exe",
            "args": [
                r"D:\Agentic AI\TripMate-AgenticAI-App\tripmate_agenticai_langgraph\custom_weather_mcp_server.py"
            ],
            "env": {
